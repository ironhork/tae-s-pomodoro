...
const translations = {
    ko: { 
        ...
        privacyTitle: "개인정보처리방침", privacyContent: `<p>본 방침은 Pomodoro Insight(이하 '사이트')의 개인정보 처리 방식을 안내합니다.</p><p>구글 애드센스를 포함한 제3자 제공업체는 사용자의 방문 기록을 바탕으로 광고를 게재하기 위해 쿠키를 사용합니다. 사용자는 구글 광고 설정에서 개인 맞춤 광고를 해제할 수 있습니다.</p>`
    },
    en: { 
        ...
        privacyTitle: "Privacy Policy", privacyContent: `<p>This policy outlines how Pomodoro Insight ('the site') handles personal information.</p><p>Third-party vendors, including Google AdSense, use cookies to serve ads based on a user's prior visits to your website or other websites. You can opt-out of personalized advertising by visiting Google Ads Settings.</p>`
    },
    hi: { 
        ...
        privacyTitle: "गोपनीयता नीति", privacyContent: `<p>यह नीति बताती है कि पोमोडोरो इनसाइट ('साइट') व्यक्तिगत जानकारी को कैसे संभालती है।</p><p>Google AdSense सहित तृतीय-पक्ष विक्रेता, आपकी वेबसाइट या अन्य वेबसाइटों पर उपयोगकर्ता की पिछली यात्राओं के आधार पर विज्ञापन देने के लिए कुकीज़ का उपयोग करते हैं।</p>`
    },
    ja: { 
        ...
        post1Full: `<h1 class="section-title">ポモドーロ・テクニックとは？</h1><p>ポモドーロ・テクニックは、1980年代後半に提案された時間管理術で、生産性を飛躍的に高めます。</p><h2>1. 基本原則</h2><p>25分間、1つの作業に集中し、5分間の短い休憩を取ります。これを4回繰り返した後、15〜30分の長い休憩を取ります。</p><h2>2. 脳科学적根拠</h2><p>成人の深い集中力は約20〜30分持続します。25分は脳が疲れる前に没入感を最大化できる最適な時間です。</p><h2>3. 実践のコツ</h2><p>物理的なタイマーを使用して緊張感を作り出し、マルチタスクを避けて1サイクル1タスクを徹底しましょう。</p>`,
        post2Full: `<h1 class="section-title">集中力を200%高める環境設定</h1><p>物理적・デジタル環境を整えることが、集中力維持の鍵です。</p><h2>1. 物理적環境（デスクテリア）</h2><p>視覚的刺激は脳のリソースを消費します。不要なものを片付け、自然光に近い照明を使用しましょう。</p><h2>2. デジタル防害禁止（デジタル・ミニマリズム）</h2><p>通知は集中の敵です。スマホを隠すか、おやすみモードに設定しましょう。不要なブラウザのタブは閉じます。</p><h2>3. 聴覚的環境</h2><p>ホワイトノイズやカフェの音（40-60dB）は、静寂よりも創造性を高めます。Lo-fiやクラシックを活用しましょう。</p>`,
        ...
        privacyTitle: "プライバシーポリシー", privacyContent: `<p>本方針は、Pomodoro Insight（以下「当サイト」）における個人情報の取り扱いについて説明するものです。</p><p>Googleアドセンスを含む第三者配信事業者は、Cookieを使用して、ユーザーが当サイトや他のサイトに過去にアクセスした際の情報に基づいて広告を配信します。</p>`
    },
    zh: { 
        ...
        privacyTitle: "隐私政策", privacyContent: `<p>本政策概述了 Pomodoro Insight（“本网站”）处理个人信息的方式。</p><p>包括 Google AdSense 在内的第三方供应商使用 Cookie 根据用户之前访问本网站或其他网站的情况来发布广告。</p>`
    },
    es: { 
        ...
        privacyTitle: "Política de Privacidad", privacyContent: `<p>Esta política describe cómo Pomodoro Insight ('el sitio') maneja la información personal.</p><p>Los proveedores externos, incluido Google AdSense, utilizan cookies para mostrar anuncios basados en las visitas anteriores del usuario a su sitio web u otros sitios web.</p>`
    },
    fr: { 
        ...
        privacyTitle: "Politique de Confidentialité", privacyContent: `<p>Cette politique décrit comment Pomodoro Insight ('le site') gère les informations personnelles.</p><p>Les fournisseurs tiers, y compris Google AdSense, utilisent des cookies pour diffuser des annonces en fonction des visites antérieures des utilisateurs sur votre site Web ou sur d'autres sites Web.</p>`
    },
    de: { 
        ...
        post3Full: `<h1 class="section-title">Richtig ausruhen gegen Burnout</h1><p>Wahre Ruhe bedeutet, die Reizufuhr zum Gehirn vollständig zu unterbrechen.</p><h2>1. Achtsames Ausruhen</h2><p>Augen zu und tief atmen. Dies aktiviert das "Default Mode Network" des Gehirns zur Informationsordnung.</p><h2>2. Körperliche Aktivierung</h2><p>Aufstehen und dehnen. Eine bessere Durchblutung bringt Sauerstoff für den nächsten Zyklus im Gehirn.</p><h2>3. Sensorischer Reset</h2><p>Keine Bildschirme in der Pause. Wasser trinken oder in die Ferne schauen, um Augen und Geist zu entspannen.</p>`,
        privacyTitle: "Datenschutzerklärung", privacyContent: `<p>In dieser Richtlinie wird dargelegt, wie Pomodoro Insight („die Website“) mit personenbezogenen Daten umgeht.</p><p>Drittanbieter, einschließlich Google AdSense, verwenden Cookies, um Anzeigen basierend auf früheren Besuchen eines Nutzers auf Ihrer Website oder anderen Websites bereitzustellen.</p>`
    },
    ru: { 
        ...
        privacyTitle: "Политика конфиденциальности", privacyContent: `<p>В настоящей политике изложен порядок обработки персональных данных в Pomodoro Insight («Сайт»).</p><p>Сторонние поставщики, в том числе Google AdSense, используют файлы cookie для показа объявлений с учетом предыдущих посещений пользователем вашего веб-сайта или других ресурсов.</p>`
    },
    pt: { 
        logo: "Pomodoro Insight", home: "Início", blog: "Blog", about: "Sobre", contact: "Contato", privacy: "Privacidade", heroTitle: "Foco", heroDesc: "Maximize sua eficiência diária com a técnica Pomodoro.", latestInsights: "Últimas", readMore: "Ler mais →", footerRights: "© 2024 Pomodoro Insight. Todos os direitos reservados.", aboutTitle: "Sobre Pomodoro Insight", aboutContent: "Pomodoro Insight é uma comunidade de produtividade profissional criada para ajudar as pessoas a gerirem seu tempo.", contactTitle: "Contato", contactDesc: "Contate-nos via e-mail para parcerias ou sugestões.", start: "INICIAR", pause: "PAUSA", timeUp: "O tempo acabou!",
        post1Title: "Técnica Pomodoro: Base Científica", post1Desc: "Por que 25 minutes de foco e 5 de descanso ajudam o cérebro?",
        ...
        privacyTitle: "Política de Privacidade", privacyContent: `<p>Esta política descreve como o Pomodoro Insight ('o site') lida com informações pessoais.</p><p>Fornecedores terceiros, incluindo o Google AdSense, utilizam cookies para apresentar anúncios com base nas visitas anteriores de um utilizador ao seu website ou a outros websites.</p>`
    },
    vi: { 
        logo: "Pomodoro Insight", home: "Trang chủ", blog: "Blog", about: "Giới thiệu", contact: "Liên hệ", privacy: "Bảo mật", heroTitle: "Tập trung", heroDesc: "Tối đa hóa hiệu quả với phương pháp Pomodoro.", latestInsights: "Mới nhất", readMore: "Xem thêm →", footerRights: "© 2024 Pomodoro Insight. Tất cả quyền được bảo lưu.", aboutTitle: "Về Pomodoro Insight", aboutContent: "Pomodoro Insight là cộng đồng năng suất chuyên nghiệp được tạo ra để giúp mọi người quản lý thời gian.", contactTitle: "Liên hệ", contactDesc: "Liên hệ qua email cho bất kỳ đề xuất nào.", start: "BẮT ĐẦU", pause: "TẠM DỪNG", timeUp: "Hết giờ!",
        ...
        privacyTitle: "Chính sách bảo mật", privacyContent: `<p>Chính sách này mô tả cách Pomodoro Insight ('trang web') xử lý thông tin cá nhân.</p><p>Các nhà cung cấp bên thứ ba, bao gồm Google AdSense, sử dụng cookie để phục vụ quảng cáo dựa trên các lần truy cập trước đó của người dùng vào trang web của bạn hoặc các trang web khác.</p>`
    },
    ar: { 
        logo: "بومودورو إنسايت", home: "الرئيسية", blog: "مدونة", about: "حول", contact: "اتصال", privacy: "الخصوصية", heroTitle: "التركيز", heroDesc: "ضاعف كفاءتك اليومية مع تقنية بومودورو.", latestInsights: "أحدث الرؤى", readMore: "اقرأ المزيد →", footerRights: "© 2024 بومودورو إنسايت. جميع الحقوق محفوظة.", aboutTitle: "حول بومودورو إنسايت", aboutContent: "مجتمع احترافي لإدارة الوقت وزيادة الإنتاجية.", contactTitle: "اتصال", contactDesc: "اتصل بنا عبر البريد الإلكتروني لأي اقتراحات.", start: "ابدأ", pause: "إيقاف", timeUp: "انتهى الوقت!",
        ...
        privacyTitle: "سياسة الخصوصية", privacyContent: `<p>توضح هذه السياسة كيفية تعامل Pomodoro Insight ("الموقع") مع المعلومات الشخصية.</p><p>يستخدم موردو الطرف الثالث، بمن فيهم Google AdSense، ملفات تعريف الارتباط لعرض الإعلانات بناءً على زيارات المستخدم السابقة لموقعك الإلكتروني أو لمواقع إلكترونية أخرى.</p>`
    }
};
...
function applyLanguage(lang) {
    ...
    document.querySelectorAll('nav ul li a, .footer-links a').forEach(link => {
        ...
        else if (href.includes('privacy.html')) link.textContent = t.privacy;
    });

    // Footer Rights Update
    const footerRights = document.querySelector('footer p');
    if (footerRights) footerRights.textContent = t.footerRights;

    // Page detection
    const isPrivacy = path.includes('privacy.html');
    ...
    if (isPrivacy) {
        ...
        if (hero) {
            hero.innerHTML = `<h1 class="section-title">${t.privacyTitle}</h1>${t.privacyContent}`;
            hero.style.textAlign = 'left';
        }
    } else if (isBlog) {
        const title = document.querySelector('main .section-title');
        if (title) title.textContent = t.latestInsights;
        ...
        if (blogCards.length >= 3) {
            ...
            const link1 = blogCards[0].querySelector('.read-more');
            ...
            const link2 = blogCards[1].querySelector('.read-more');
            ...
            const link3 = blogCards[2].querySelector('.read-more');
            if (link3) link3.textContent = t.readMore;
        }
    } else if (isAbout) {
        const title = document.querySelector('main .section-title');
    ...
    } else if (isPost1 || isPost2 || isPost3) {
        ...
        if (startBtn) startBtn.textContent = isRunning ? t.pause : t.start;
    }
    ...
    else if (isPrivacy) pageTitle = t.privacyTitle;
    else if (isBlog) pageTitle = t.latestInsights;
...
async function translateArticle(targetLang) {
    ...
    try {
        ...
        if (data.responseData) {
            article.innerText = data.responseData.translatedText;
        }
    } catch (err) {
...
function updatePostContent(lang) {
    const t = translations[lang] || translations["en"];
    const article = document.getElementById("post-content") || document.querySelector('main article.hero');
    if (!article) return;
    const page = window.location.pathname;

    if (page.includes("post-1")) {
        article.innerHTML = t.post1Full;
    } else if (page.includes("post-2")) {
        article.innerHTML = t.post2Full;
    } else if (page.includes("post-3")) {
